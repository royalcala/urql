...
> implements Cache
{
  ...
  /** Get the TinyBase store instance for direct access to entities as tables */
  getTinyBase(): TinyBaseStore {
    return getTinyBaseStore();
  }

  /** Hydrate TinyBase with current GraphBase data */
  hydrateTinyBase(): void {
    hydrateTinyBaseFromGraphBase(this.data);
  }
}
