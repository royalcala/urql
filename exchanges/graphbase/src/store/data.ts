...
import { syncRecordToTinyBase } from './tinybase-adapter';
...
export const writeRecord = (
  ...
  // Sync to TinyBase if we're writing to the base layer (not optimistic)
  if (!currentOptimisticKey && value !== undefined) {
    syncRecordToTinyBase(entityKey, fieldKey, value);
  }
};
